        ...
        {content.map((project) => (
          <Col key={project.id}>
            <Card style={{height:"550px"}}>
              <Card.Img variant="top" src={project.image}  style={{width:"700px",height:"300px" , marginLeft:"75px",marginTop:"15px"}}/>
              <Card.Body>
                <Card.Title className="projectsSectionTitle">{project.title}</Card.Title>
